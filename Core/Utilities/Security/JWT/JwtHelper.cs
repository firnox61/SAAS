...
namespace Core.Utilities.Security.JWT
{
    public class JwtHelper : ITokenHelper
    {
        ...
        public AccessToken CreateToken(User user, List<OperationClaim> operationClaims)
        {
            ...
            var jwt = CreateJwtSecurityToken(_tokenOptions, user, signingCredentials, operationClaims);//bizim için jsw üretecek
            var jwtSecurityTokenHandler = new JwtSecurityTokenHandler();//elimizdeki bilgilere göre handlerla göremmiz lazım
            var token = jwtSecurityTokenHandler.WriteToken(jwt);//strige çevirdik
